...
It can also be used with [Google colab](https://colab.research.google.com/). Tutorials 0 to 6 are basic tutorials covering the fundamental usage of FastDDM. Tutorials 7 to 9 present advanced applications of DDM.
